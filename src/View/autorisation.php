...
<body class="fullscreen">
	...
	<form class="registration">
		...
		<input type="submit" value="Войти!" class="registration__button login-button">
	</form>
	<p class="relocate">Еще нет аккаунта? <a class="relocate__link" href="registration.php">Зарегистрируйтесь!</a></p>
